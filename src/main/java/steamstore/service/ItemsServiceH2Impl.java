...
//
//public class ItemsServiceH2Impl implements ItemsService {
//    private final DotaDao dotaDao;
//    private final CsGoDao csGoDao;
//
//    public ItemsServiceH2Impl(DotaDao dotaDao, CsGoDao csGoDao) {
...
//
//    @Override
//    public CsGoItem addCsItem(String name, String quality, double cost, Stringrarity, String weapon, String itemCategory, String itemType, double floatValue) throws NewItemException{
